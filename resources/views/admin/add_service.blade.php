...
<div class="container">
    <h2>ADD VPS</h2>
    <form method="post" action="{{ route('admin.post_addvps') }}">
        @csrf
        <label for="nameHosting">VPS Images:</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-image"></i></span>
                </div>
        ...
        <div class="form-group">
            <label for="nameHosting">VPS Name:</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-server"></i></span>
                </div>
                <input type="text" name="namevps" class="form-control" id="nameHosting" placeholder="Enter hosting name" required>
            </div>
        </div>
        <div class="form-group">
            <label for="moTa">Description:</label>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" name="storage" class="form-control" id="storage" placeholder="Enter data hosting" required>
            </div>
        </div>
        <div class="form-group">
            <label for="bandwidth">Bandwidth:</label>
...
@else
    <h1>Lỗi Không Xác Định Service</h1>
@endif
@endsection
