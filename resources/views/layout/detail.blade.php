...
@section('content')
            ...
            <div class="grid-container">
                <div class="info-column">
                    <div class="hosting-info">
                        ...
                        <ul class="supp">
                            <li><strong>Dung Lượng: {{$product->data_Hosting}} GB NVME</strong></li>
                               @php
                                      $lines = explode("\n", $product->mo_ta);
                               @endphp
                               ...
                               @endforeach
                               <li><strong>Băng Thông: </strong>{{$product->bandwidth}}MB/S</li>
                            </ul>
                    </div>
                </div>
                @php 
                    $price = number_format($product->GiaTien, 0);
                @endphp
                ...
                <div class="total-column">
                    <div class="total-price">
                        ...
                        <br> <br>
                        <form method="POST" action="{{ route('payment_vnpay',['type'=>$product->type_product]) }}">
                            @csrf
                            <input type="hidden" id="totalpay" name="totalpay" value="">
                            <button type="submit" class="read_more read_more_button">Thanh Toán</button>
                        </form>
                        <br>
                        <form method="POST" action="{{ route('addcart', [ 'type'=>$product->type_product, 'id' => $product->ID]) }}">
                            @csrf
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                <div class="titlepage text_align_center">
                         <h2>GIA HẠN<span class="blue_light"> VPS</span></h2>
                      </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
            <div class="grid-container">
                ...
                <input id="price" type="hidden" value="{{$product->GiaTien}}">
                <div class="options-column">
                    <div class="subscription-options">
                        <h2>Lựa chọn thời hạn:</h2><hr>
                        <div class="option">
        ...
        @else
           <H1>Lỗi Không Nhận Diện Được Loại Dịch Vụ</H1>
        @endif
