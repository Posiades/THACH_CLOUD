...
<html lang="en">
   <head>
      ...
      <meta property="og:title" content="THACH CLOUD | @yield('title')">
      <meta property="og:image" content="{{asset('images/icons/logo.png')}}">
      <meta property="og:description" content="Thach Cloud cung cấp dịch vụ Hosting và VPS chất lượng cao.">
      <meta property="og:site_name" content="Thach Cloud">
