            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>CHÚNG TÔI ĐẢM BẢO <span class="blue_light">CHẤT LƯỢNG</span></h2>
                     <p> <strong>THACH CLOUD</strong> cam kết cung cấp dịch vụ hosting và VPS chất lượng hàng đầu, đảm bảo hiệu suất cao, độ tin cậy và sự hỗ trợ tận tình.
                     </p>
                  </div>
               </div>
            </div>
               ...
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>Gigabyte Internet</h3>
                        <p>Cung cấp các dịch có tốc độ Internet cực cao, mang lại trải nghiệm Internet tuyệt vời cho Website của bạn</p>
                     </div>
               ...
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>Lưu Trữ SDD</h3>
                        <p>Sản phẩm của chúng tôi được trang bị các ổ cứng SSD NVME, giúp tăng tốc tối đa quá trình loading website của bạn</p>
                     </div>
                     {{-- <a class="read_more" href="hosting.html">Read More</a> --}}
                  </div>
               </div>
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <p>cam kết bảo mật tuyệt đối dữ liệu và thông tin cá nhân của bạn, sử dụng nhiều lớp firewall giúp ngăn chặn tuyệt đối rò tỉ dữ liệu</p>
                     </div>
                     {{-- <a class="read_more" href="hosting.html">Read More</a> --}}
                  </div>
               </div>
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>Đảm Bảo</h3>
                        <p>Chúng tôi đảm bảo tuyệt đối về chất lượng dịch vụ và quyền lợi của khách hàng khi sử dụng dịch vụ của chúng tôi</p>
                     </div>
                     {{-- <a class="read_more" href="hosting.html">Read More</a> --}}
                  </div>
               </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-8 offset-md-2">
                  <div class="titlepage text_align_center">
                     <h2>Khám phá các gói Hosting tuyệt vời của chúng tôi<br> <span class="blue_light">Đăng kí ngay hôm nay</span></h2>
                     <p>Hỗ Trợ mạnh phần cứng mạnh mẽ và hiện đại. <strong>THACH CLOUD</strong> cung cấp các gói Hosting hiệu năng trên giá thành (P/P) tốt nhất trên thị trường.
                     </p>
                  </div>
               </div>
            </div>
      ...
      <div class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>Về Phía <span class="blue_light"> THACH CLOUD Comapny</span></h2>
                  </div>
               </div>
               <div class="col-md-10 offset-md-1">
                  <div class="about_img text_align_center">
                     ...
                     <p>
                        Chúng tôi là một đội ngũ chuyên nghiệp và tâm huyết, cam kết cung cấp các dịch vụ hosting, VPS và tên miền hàng đầu để giúp bạn thúc đẩy sự thành công trực tuyến của mình. Tại THACH CLOUD, chúng tôi không chỉ cung cấp những dịch vụ tuyệt vời mà còn tạo ra một môi trường đáng tin cậy và an toàn cho dữ liệu của bạn
                     </p>
                        <a class="read_more" href=" {{route('about')}}">Xem Thêm</a>
                  </div>
               </div>
            </div>
         </div>
